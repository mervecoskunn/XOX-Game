...
# this function will switch player if current player is player, it will change to computer and vice versa
def switchPlayer():
...
def getPlayerMark():
    ...
    while True:
        ...
        # strip function will remove spaces from start and end of string and convert to uppercase to compare easily
...
# this function will show loading animation from (I edited a little bit): https://medium.com/@joloiuy/creating-captivating-terminal-animations-in-python-a-fun-and-interactive-guide-2eeb2a6b25ec 
    ...
    while True:
        ...
        if(not row.isnumeric()) or (not column.isnumeric()):
            ...
            if((row < 1 or row > 3 or column < 1 or column > 3)):
                ...
                return userChoise
# this function will mark choise with player or computer mark and if choise is empty, it will return true, else false
